...
public class ImageHelper {
     ...
     *                      usual one-step technique (only useful in downscaling
     *                      cases, targetDim is smaller than the original
     *                      dimensions, and generally only when the {@code BILINEAR}
     *                      hint is specified)
     ...
     * and the area it is to be drawn in
